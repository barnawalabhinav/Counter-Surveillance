...
time src/main.o --n 100 --m 0.1 --k 0.1 --p 0.75 --q 0.25 --r 0.5 --a 0.3 --b 0.05 --d 0.0 --threads 1 --mode plot
# time src/main.o --n 100 --m 0.1 --k 0.1 --p 0.75 --q 0.25 --r 0.5 --a 0.3 --b 0.05 --threads 1 --mode regress
# time src/main.o --p 0.75 --q 0.25 --r 0.3 --threads 18 --mode regress
